...
const bimtekModules: Record<string, { title: string; category: string; pkb: number; duration: string; level: string; content: string; mentor: string }> = {
  ...
  'iso9001-1': { title: 'ISO 9001:2015 - Pengenalan Sistem Mutu', category: 'ISO Management', pkb: 15, duration: '8 jam', level: 'Ahli', content: 'Pengenalan standar ISO 9001:2015 tentang Sistem Manajemen Mutu. Memahami clause, struktur High Level (HLS), dan manfaat implementasi SMM.', mentor: 'Ahli Sistem Mutu' },
  'iso9001-2': { title: 'Prinsip TQM dan PDCA', category: 'ISO Management', pkb: 12, duration: '6 jam', level: 'Ahli', content: 'Total Quality Management (TQM) dan siklus PDCA (Plan-Do-Check-Act) dalam konteks ISO 9001.', mentor: 'Ahli Sistem Mutu' },
  'iso9001-3': { title: 'Penyusunan Manual Mutu', category: 'ISO Management', pkb: 15, duration: '8 jam', level: 'Ahli', content: 'Teknik penyusunan Manual Mutu yang sesuai dengan persyaratan ISO 9001:2015 clause 4-10.', mentor: 'Ahli Sistem Mutu' },
  'iso9001-4': { title: 'Prosedur dan Instruksi Kerja', category: 'ISO Management', pkb: 10, duration: '5 jam', level: 'Ahli', content: 'Penyusunan prosedur kerja dan instruksi kerja yang efektif dan terdokumentasi.', mentor: 'Ahli Sistem Mutu' },
  'iso9001-5': { title: 'Audit Internal Mutu', category: 'ISO Management', pkb: 15, duration: '8 jam', level: 'Ahli', content: 'Pelaksanaan audit internal Sistem Manajemen Mutu sesuai ISO 19011. Teknik pengauditan dan penyusunan laporan.', mentor: 'Ahli Auditor' },
  'iso9001-6': { title: 'Teknik Audit Internal ISO 9001', category: 'ISO Management', pkb: 12, duration: '6 jam', level: 'Ahli', content: 'Teknik lanjutan audit internal: checklist, sampling, teknik wawancara, dan penemuan audit.', mentor: 'Ahli Auditor' },
  'iso9001-7': { title: 'Document Control dan Records Management', category: 'ISO Management', pkb: 10, duration: '5 jam', level: 'Ahli', content: 'Pengelolaan dokumen dan rekaman sesuai ISO 9001 clause 7.5. Control of documents and records.', mentor: 'Ahli Sistem Mutu' },
  'iso9001-8': { title: 'Management Review Meeting', category: 'ISO Management', pkb: 8, duration: '4 jam', level: 'Manager', content: 'Penyelenggaraan Management Review Meeting yang efektif sesuai ISO 9001 clause 9.3.', mentor: 'Ahli Sistem Mutu' },
  'iso9001-9': { title: 'Corrective Action dan Preventive Action (CAPA)', category: 'ISO Management', pkb: 10, duration: '5 jam', level: 'Ahli', content: 'Teknik CAPA (Corrective Action & Preventive Action) untuk penanganan ketidaksesuaian.', mentor: 'Ahli Sistem Mutu' },
  'iso9001-10': { title: 'Audit Eksternal ISO 9001 (Sertifikasi)', category: 'ISO Management', pkb: 15, duration: '8 jam', level: 'Ahli', content: 'Persiapan audit eksternal sertifikasi ISO 9001. Tahapan, dokumen, dan tips keberhasilan.', mentor: 'Ahli Auditor' },
  // === ISO 37001 - SISTEM MANAJEMEN ANTI PENYUAPAN (SMAP) ===
  'iso37001-1': { title: 'ISO 37001:2016 - Pengenalan SMAP', category: 'ISO Management', pkb: 15, duration: '8 jam', level: 'Ahli', content: 'Pengenalan ISO 37001:2016 Sistem Manajemen Anti Penyuapan. Struktur standar dan persyaratan kunci.', mentor: 'Ahli SMAP' },
  'iso37001-2': { title: 'Kebijakan Anti Penyuapan', category: 'ISO Management', pkb: 10, duration: '5 jam', level: 'Ahli', content: 'Penyusunan kebijakan anti penyuapan yang efektif dan sesuai persyaratan ISO 37001.', mentor: 'Ahli SMAP' },
  'iso37001-3': { title: 'Due Diligence dan Risk Assessment', category: 'ISO Management', pkb: 12, duration: '6 jam', level: 'Ahli', content: 'Teknik due diligence dan penilaian risiko penyuapan dalam organisasi.', mentor: 'Ahli SMAP' },
  'iso37001-4': { title: 'Pengendalian Pembayaran dan Hadiah', category: 'ISO Management', pkb: 10, duration: '5 jam', level: 'Ahli', content: 'Pengendalian pembayaran, hadiah, hiburan, dan hospitality sesuai standar SMAP.', mentor: 'Ahli SMAP' },
  'iso37001-5': { title: 'Audit Internal SMAP', category: 'ISO Management', pkb: 15, duration: '8 jam', level: 'Ahli', content: 'Pelaksanaan audit internal Sistem Manajemen Anti Penyuapan.', mentor: 'Ahli Auditor SMAP' },
  'iso37001-6': { title: 'Pelaporan dan Investigasi Pelanggaran', category: 'ISO Management', pkb: 12, duration: '6 jam', level: 'Ahli', content: 'Mekanisme pelaporan dan investigasi pelanggaran anti penyuapan.', mentor: 'Ahli SMAP' },
  'iso37001-7': { title: 'Whistleblowing System', category: 'ISO Management', pkb: 10, duration: '5 jam', level: 'Ahli', content: 'Penyusunan sistem whistleblowing yang efektif dan aman.', mentor: 'Ahli SMAP' },
  'iso37001-8': { title: 'Audit Eksternal ISO 37001 (Sertifikasi)', category: 'ISO Management', pkb: 15, duration: '8 jam', level: 'Ahli', content: 'Persiapan dan proses sertifikasi ISO 37001 oleh lembaga sertifikasi.', mentor: 'Ahli Auditor SMAP' },
  // === PANDUAN CEGAH KORUPSI (PANCEK/KPK) ===
  'antikorupsi-1': { title: 'Panduan Pencegahan Korupsi Konstruksi', category: 'ISO Management', pkb: 15, duration: '8 jam', level: 'Ahli', content: 'Panduan komprehensif pencegahan korupsi di sektor konstruksi berdasarkan standar APEC dan praktik internasional.', mentor: 'Ahli Anti Korupsi' },
  'antikorupsi-2': { title: 'Gratifikasi dan Conflict of Interest', category: 'ISO Management', pkb: 12, duration: '6 jam', level: 'Ahli', content: 'Pengelolaan gratifikasi dan konflik kepentingan di lingkungan kerja konstruksi.', mentor: 'Ahli Anti Korupsi' },
  'antikorupsi-3': { title: 'Kode Etik dan Perilaku Anti Korupsi', category: 'ISO Management', pkb: 10, duration: '5 jam', level: 'Ahli', content: 'Penyusunan kode etik dan standar perilaku anti korupsi untuk organisasi.', mentor: 'Ahli Anti Korupsi' },
  'antikorupsi-4': { title: 'Pengelolaan Risiko Korupsi', category: 'ISO Management', pkb: 12, duration: '6 jam', level: 'Ahli', content: 'Identifikasi dan pengelolaan risiko korupsi dalam proyek konstruksi.', mentor: 'Ahli Anti Korupsi' },
  'antikorupsi-5': { title: 'Audit Internal Anti Korupsi', category: 'ISO Management', pkb: 15, duration: '8 jam', level: 'Ahli', content: 'Teknik audit internal untuk mendeteksi dan mencegah korupsi.', mentor: 'Ahli Auditor' },
  'antikorupsi-6': { title: 'Sistem Pelaporan Gratifikasi', category: 'ISO Management', pkb: 10, duration: '5 jam', level: 'Ahli', content: 'Penyusunan sistem pelaporan gratifikasi sesuai regulasiKPK.', mentor: 'Ahli Anti Korupsi' },
  // === ISO 45001 - SISTEM MANAJEMEN KESELAMATAN KERJA (SMK3) ===
  'iso45001-1': { title: 'ISO 45001:2018 - Pengenalan SMK3', category: 'ISO Management', pkb: 15, duration: '8 jam', level: 'Ahli', content: 'Pengenalan ISO 45001:2018 Sistem Manajemen Keselamatan dan Kesehatan Kerja. Perbedaan dengan OHSAS 18001.', mentor: 'Ahli K3' },
  'iso45001-2': { title: 'Context of Organization dan Risk Assessment', category: 'ISO Management', pkb: 12, duration: '6 jam', level: 'Ahli', content: 'Penentuan konteks organisasi dan penilaian risiko K3 sesuai ISO 45001 clause 4 & 6.', mentor: 'Ahli K3' },
  'iso45001-3': { title: 'Kebijakan K3 dan Perencanaan', category: 'ISO Management', pkb: 10, duration: '5 jam', level: 'Ahli', content: 'Penyusunan kebijakan K3 dan perencanaan sistem manajemen keselamatan kerja.', mentor: 'Ahli K3' },
  'iso45001-4': { title: 'Identifikasi Bahaya dan Penilaian Risiko', category: 'ISO Management', pkb: 12, duration: '6 jam', level: 'Ahli', content: 'Teknik identifikasi bahaya dan penilaian risiko di tempat kerja konstruksi.', mentor: 'Ahli K3' },
  'iso45001-5': { title: 'Audit Internal K3', category: 'ISO Management', pkb: 15, duration: '8 jam', level: 'Ahli', content: 'Pelaksanaan audit internal Sistem Manajemen K3 sesuai ISO 45001.', mentor: 'Ahli Auditor K3' },
  'iso45001-6': { title: 'Techno and Engineering Control', category: 'ISO Management', pkb: 10, duration: '5 jam', level: 'Ahli', content: 'Pengendalian teknis dan rekayasa untuk keselamatan kerja.', mentor: 'Ahli K3' },
  'iso45001-7': { title: 'PPE dan Perlindungan Pekerja', category: 'ISO Management', pkb: 8, duration: '4 jam', level: 'Ahli', content: 'Alat Pelindung Diri (APD) dan perlindungan pekerja di proyek konstruksi.', mentor: 'Ahli K3' },
  'iso45001-8': { title: 'Investigation and Incident Reporting', category: 'ISO Management', pkb: 10, duration: '5 jam', level: 'Ahli', content: 'Investigasi kecelakaan dan pelaporan insiden K3.', mentor: 'Ahli K3' },
  'iso45001-9': { title: 'Audit Eksternal ISO 45001 (Sertifikasi)', category: 'ISO Management', pkb: 15, duration: '8 jam', level: 'Ahli', content: 'Persiapan sertifikasi ISO 45001 oleh lembaga sertifikasi terakreditasi.', mentor: 'Ahli Auditor K3' },
  // === ISO 14001 - SISTEM MANAJEMEN LINGKUNGAN ===
  'iso14001-1': { title: 'ISO 14001:2015 - Pengenalan SML', category: 'ISO Management', pkb: 15, duration: '8 jam', level: 'Ahli', content: 'Pengenalan ISO 14001:2015 Sistem Manajemen Lingkungan. Struktur dan persyaratan standar.', mentor: 'Ahli Lingkungan' },
  'iso14001-2': { title: 'Aspek dan Dampak Lingkungan', category: 'ISO Management', pkb: 12, duration: '6 jam', level: 'Ahli', content: 'Identifikasi aspek dan penilaian dampak lingkungan kegiatan konstruksi.', mentor: 'Ahli Lingkungan' },
  'iso14001-3': { title: 'Kebijakan Lingkungan dan Perencanaan', category: 'ISO Management', pkb: 10, duration: '5 jam', level: 'Ahli', content: 'Penyusunan kebijakan lingkungan dan perencanaan SML.', mentor: 'Ahli Lingkungan' },
  'iso14001-4': { title: 'Pengelolaan Limbah dan Emisi', category: 'ISO Management', pkb: 12, duration: '6 jam', level: 'Ahli', content: 'Pengelolaan limbah konstruksi, emisi, dan pencemaran lingkungan.', mentor: 'Ahli Lingkungan' },
  'iso14001-5': { title: 'Audit Internal Lingkungan', category: 'ISO Management', pkb: 15, duration: '8 jam', level: 'Ahli', content: 'Pelaksanaan audit internal Sistem Manajemen Lingkungan.', mentor: 'Ahli Auditor Lingkungan' },
  'iso14001-6': { title: 'Compliance Obligation dan Legal Register', category: 'ISO Management', pkb: 10, duration: '5 jam', level: 'Ahli', content: 'Kepatuhan terhadap kewajiban hukum lingkungan dan registrasi regulasi.', mentor: 'Ahli Lingkungan' },
  'iso14001-7': { title: 'Energy Management dan Carbon Footprint', category: 'ISO Management', pkb: 10, duration: '5 jam', level: 'Ahli', content: 'Manajemen energi dan perhitungan jejak karbon dalam konstruksi.', mentor: 'Ahli Lingkungan' },
  'iso14001-8': { title: 'Audit Eksternal ISO 14001 (Sertifikasi)', category: 'ISO Management', pkb: 15, duration: '8 jam', level: 'Ahli', content: 'Persiapan sertifikasi ISO 14001 oleh lembaga sertifikasi.', mentor: 'Ahli Auditor Lingkungan' },
};
